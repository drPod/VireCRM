...
// runtime imports — unit-testable in the Workers vitest pool.
//
...
const RATE_LIMIT_MESSAGE = "Too many sign-in attempts. Please wait a moment and try again.";
const NETWORK_MESSAGE = "Couldn't reach the sign-in service. Check your connection.";
...
/**
 * Translate a Worker error code (from the post-login `/api/auth/whoami`
 * probe) into user copy. Used after `signInWithPassword` succeeded but the
 * JWT doesn't match the request host / role context.
 *
