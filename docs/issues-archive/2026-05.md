# Issues archive — 2026-05

Frozen archive of sessions from 2026-05-17 through 2026-05-18. Live log moved to root `ISSUES.md` on 2026-05-18.

Searchable corpus — grep on demand. Outstanding action items extracted to root `ISSUES.md` `## Open` at archive time.

Tags inline below let `grep -E "\[cf-saas\]|\[security\]"` etc surface every entry on a topic across the whole archive. Index file: `docs/issues-archive/README.md`.

---

## Table of contents

### 2026-05-18 — Lovable-cleanup polish + CF for SaaS hardening

| Section | Tags |
|---|---|
| [`/preview` rich rebuild + bug fix sweep](#2026-05-18--preview-rich-rebuild--bug-fix-sweep) | `[marketing] [feat] [bug]` |
| [DomainHealthPanel TXT-value fix](#2026-05-18--domainhealthpanel-txt-value-fix) | `[cf-saas] [reseller] [bug]` |
| [`/features` rebuild + `/preview` rebuild plan](#2026-05-18--features-rebuild--preview-rebuild-plan) | `[marketing] [feat]` |
| [CF for SaaS e2e + DomainHealthPanel smoke](#2026-05-18-cf-for-saas-e2e--domainhealthpanel-smoke) | `[cf-saas] [reseller] [e2e]` |
| [CF for SaaS route binding + prod 404 recovery](#2026-05-18-cf-for-saas-route-binding--prod-404-recovery) | `[cf-saas] [host] [bug]` |
| [Easy-wins sweep — promo expiry + unsubscribe per-state title + stale audit cleanup](#2026-05-18-easy-wins-sweep--promo-expiry--unsubscribe-per-state-title--stale-audit-cleanup) | `[polish] [marketing]` |
| [CF wire post-verify fixes — 503 detection + JSX crash + AlertDialog](#2026-05-18-cf-wire-post-verify-fixes--503-detection--jsx-crash--alertdialog) | `[cf-saas] [bug] [frontend]` |
| [Polish pass — 10 small fixes via parallel subagents](#2026-05-18-polish-pass--10-small-fixes-via-parallel-subagents) | `[polish] [frontend]` |
| [EditClientWhiteLabelDialog CF wire — auth + shared helpers](#2026-05-18-editclientwhitelabeldialog-cf-wire--auth--shared-helpers) | `[cf-saas] [reseller] [frontend]` |
| [Vercel project deletion](#2026-05-18-vercel-project-deletion) | `[cf-saas] [host]` |

### 2026-05-17 — Initial audit + Phase 1 Lovable migration + workflows + CF migration

| Section | Tags |
|---|---|
| [Fixes shipped (orchestrator session)](#fixes-shipped-2026-05-17-orchestrator-session) | `[orchestrator] [security] [cors] [meta] [reseller] [mobile]` |
| [Public-facing (marketing) issues](#public-facing-marketing-issues) | `[audit] [marketing]` |
| [Auth-gated CRM (source audit)](#auth-gated-crm-the-real-app--discovered-via-source-audit-not-browser-verified) | `[audit] [auth-gated]` |
| [Backend state](#backend-state-2026-05-17) | `[audit] [backend]` |
| [Build-out priorities](#build-out-priorities-tbd--fill-as-we-go) | `[plan]` |
| [Auth-gated browser audit — pass 2](#auth-gated-browser-audit--pass-2-2026-05-17-post-env-fix) | `[audit] [browser] [auth-gated]` |
| [Browser-verified audit — pass 1](#browser-verified-audit--pass-1-2026-05-17-pre-env-fix) | `[audit] [browser]` |
| [Landing-page audit](#landing-page-audit-2026-05-17-agent-browser-tour) | `[audit] [marketing] [browser]` |
| [Audit continuation](#audit-continuation-2026-05-17-session-genesisxsx-tour) | `[audit]` |
| [Gated CRM audit](#gated-crm-audit-2026-05-17-test-account) | `[audit] [auth-gated]` |
| [Server-side + DB audit](#server-side--db-audit-2026-05-17-service-role-restored) | `[audit] [supabase] [security]` |
| [Security pass 2 audit](#security-pass-2-audit-2026-05-17) | `[security]` |
| [Workflow engine build-out](#workflow-engine-build-out-2026-05-17-orchestrator-session) | `[workflows] [feat]` |
| [Cloudflare migration](#2026-05-17-cloudflare-migration) | `[cf-saas] [deploy] [host]` |
| [Resend e2e verification + LOVABLE_API_KEY cleanup](#2026-05-17-resend-e2e-verification--lovable_api_key-cleanup) | `[resend] [lovable-migration] [email]` |
| [Frontend pass (sticky-stack + brand purge + audit kickoff)](#frontend-pass-2026-05-17-sticky-stack--brand-purge--audit-kickoff) | `[frontend] [rebrand]` |
| [Frontend pass continuation (OAuth migration + brand sweep)](#frontend-pass-continuation-2026-05-17-oauth-migration--brand-sweep) | `[frontend] [rebrand] [oauth]` |
| [Phase 1 regression fix — AI classify on Cloudflare Workers](#2026-05-17-phase-1-regression-fix--ai-classify-on-cloudflare-workers) | `[cf-saas] [ai] [bug]` |
| [Frontend audit follow-ups](#frontend-audit-follow-ups-2026-05-17-evening) | `[frontend] [audit]` |
| [Frontend handoff follow-ups](#frontend-handoff-follow-ups-2026-05-17-late-evening) | `[frontend] [handoff]` |
| [CustomDomainsPanel CF wire + DomainHealthPanel status badges](#customdomainspanel-cf-wire--domainhealthpanel-status-badges-2026-05-17-midnight) | `[cf-saas] [reseller] [frontend]` |
| [Smoke walk findings](#smoke-walk-findings-2026-05-17-late-evening) | `[smoke] [audit]` |

### Tag glossary

| Tag | Meaning |
|---|---|
| `[ai]` | Anthropic SDK, AI gateway, classification pipeline |
| `[audit]` | Discovery pass, no code change |
| `[auth-gated]` | `/_app.*` routes (require login) |
| `[backend]` | Supabase schema, RPC, RLS, edge fns |
| `[browser]` | Verified via agent-browser / Playwright |
| `[bug]` | Bug fix, not feature work |
| `[cf-saas]` | Cloudflare for SaaS / custom hostnames / `customers.majix.ai` |
| `[cors]` | CORS allow-list / origin validation |
| `[deploy]` | wrangler deploy, CI, infra wiring |
| `[e2e]` | End-to-end test (real services) |
| `[email]` | Resend, transactional templates, DNS |
| `[feat]` | New user-visible feature or rebuild |
| `[frontend]` | UI / React / shadcn changes |
| `[handoff]` | Session-to-session continuation notes |
| `[host]` | Hostname/routing config (Vercel exit, CF Workers, domains) |
| `[lovable-migration]` | De-Lovable cleanup (Phase 1/2) |
| `[marketing]` | Public-facing routes (`/`, `/features`, `/preview`, `/pricing`) |
| `[meta]` | `<head>` / titles / OG / SEO |
| `[mobile]` | Mobile-specific (drawer, layout) |
| `[oauth]` | Social signin, OAuth proxy, Nango candidate |
| `[orchestrator]` | Multi-subagent parallel session |
| `[plan]` | Planning doc / TBD list |
| `[polish]` | Quick wins, small fixes |
| `[rebrand]` | vireonx.space → majix.ai sweep |
| `[reseller]` | `is_reseller` org features, white-label, custom domains |
| `[resend]` | Resend SDK / DNS / verified sender |
| `[security]` | RLS, captcha, rate limit, cron secret, auth |
| `[smoke]` | Smoke test against live prod |
| `[supabase]` | Migrations, RLS, edge fns, project config |
| `[workflows]` | Workflow engine, run queue, AI agent dispatch |
