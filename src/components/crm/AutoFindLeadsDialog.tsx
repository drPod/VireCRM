...
const PERSONA_PRESETS = ["Founder/CEO", "Head of Sales", "Marketing Lead", "Operations"] as const;
          ...
          <div className="rounded-lg border border-border bg-secondary/30 px-3 py-2.5 space-y-1.5">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="text-muted-foreground">
                <span className="font-semibold text-foreground">{usage!.used}</span> /{" "}
                {usage!.quota}
              </span>
            </div>
        ...
        {needsIntegration ? (
          <div className="space-y-4 py-4">
            ...
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-3 text-xs space-y-1.5">
              ...
              <ul className="space-y-1 text-muted-foreground pl-5 list-disc">
                ...
                <li>
                  <span className="text-foreground font-medium">Use platform credits</span> — comes
                  with your plan, no setup needed (Apollo only).
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="rounded-lg border border-warning/30 bg-warning/5 px-3 py-2 text-xs text-foreground flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-muted-foreground">
                      Retrying before then will fail. Upgrade or add your own Apollo key to keep
                      going now.
                    </span>
                  </div>
                </div>
          ...
          <div className="space-y-4 pt-2">
            <div>
              ...
              >
                <option value="apollo">
                  Apollo.io — search by title/industry (1 credit per lead)
                </option>
              ...
              <div className="sm:col-span-2">
                ...
                {showQuotaBar && wouldExceedCap && usage!.remaining > 0 && (
                  <p className="mt-1 text-[11px] text-warning">
                    Only {usage!.remaining} credit{usage!.remaining === 1 ? "" : "s"} left this
                    month — pick a smaller batch or upgrade.
                  </p>
                )}
              </div>
            </div>
