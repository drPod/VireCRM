 ...
 * that's used as the Reply-To on all outreach emails sent through VireCRM.
 *
  ...
  return (
    <Card className="p-6">
      ...
      <p className="text-sm text-muted-foreground mb-3">
        The address VireCRM uses as <strong className="text-foreground">Reply-To</strong> on every
