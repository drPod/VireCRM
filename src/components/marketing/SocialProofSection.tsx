...
const testimonials = [
  {
    quote:
      "We were losing 60% of our leads to slow follow-up. After Majix, our close rate tripled because our reps finally talked to leads while they were still hot. The AI doesn't forget, doesn't get tired, and doesn't take weekends off.",
    name: "Jessica Torres",
