...
const ROWS: Row[] = [
  {
    label: "AI lead scoring with explainable signals",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "partial",
    competitor: "yes",
  ...
  {
    label: "Multi-channel inbox (Email + SMS + WhatsApp + DMs)",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "partial",
    competitor: "no",
  ...
  {
    label: "Built-in calendar + round-robin booking",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "yes",
    competitor: "partial",
  ...
  {
    label: "Visual workflow builder with AI nodes",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "partial",
    competitor: "no",
  ...
  {
    label: "Industry verticals (Energy / Solar / Real Estate / Gym / Insurance)",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "no",
    competitor: "no",
  ...
  {
    label: "White-label custom domain per tenant",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "no",
    competitor: "partial",
  ...
  {
    label: "Reseller-controlled pricing + billing",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "no",
    competitor: "no",
  ...
  {
    label: "AI sequence drafting + reply classification",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "partial",
    competitor: "partial",
  ...
  {
    label: "Per-org Stripe Connect for payouts",
    virecrm: "yes",
    spreadsheet: "no",
    generic: "no",
    competitor: "no",
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-card/80 text-xs uppercase tracking-wide text-muted-foreground">
                ...
                <th className="w-[15%] px-3 py-4 text-center font-semibold text-primary">
                  VireCRM
                </th>
                ...
                >
                  ...
                  <td className="px-3 py-3.5 text-center">
                    <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-primary/10">
                      <CellIcon value={r.virecrm} />
                    </span>
                  </td>
                  <td className="px-3 py-3.5 text-center">
                    <CellIcon value={r.spreadsheet} />
                  </td>
                  <td className="px-3 py-3.5 text-center">
                    <CellIcon value={r.generic} />
                  </td>
                  <td className="px-3 py-3.5 text-center">
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Comparison reflects published features on competitor sites as of{" "}
          {new Date().getFullYear()}. “Generic CRM” represents Pipedrive / HubSpot Starter-tier
          feature surface.
        </p>
      </div>
    </section>
