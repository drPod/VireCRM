...
export const REVIEWS: Review[] = [
  ...
  { id: "R-602", source: "G2", reviewer: "Priya P.", rating: 5, title: "White-label is real white-label", body: "Most CRMs claim white-label but VireCRM actually delivers. Custom domains, custom theming, the works. Our clients never see VireCRM.", date: "May 8", responded: true },
  ...
  { id: "R-605", source: "Yelp", reviewer: "Hannah G.", rating: 5, title: "Stride Gym switched and never looked back", body: "We left HubSpot for VireCRM. Every feature we needed plus the SMS automation actually works. Members rebook 2x.", date: "Apr 28", responded: true },
  { id: "R-606", source: "G2", reviewer: "Felix A.", rating: 5, title: "AI Advisor pays for itself", body: "I asked VireCRM to find me 10 leads ready to buy this week. It did. Closed 3. ROI in week one.", date: "Apr 24", responded: true },
];
