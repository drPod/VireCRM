    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Your account password for {senderName} has been reset. Your
          ...
          <Text style={text}>
            Sign in with this password and change it from your account settings
            for added security.
          </Text>

          <Text style={footer}>
            If you didn't request this reset, contact your account
