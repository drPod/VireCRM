      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={stepBox}>
            ...
            <Text style={stepBody}>
              Open the <strong>AI Advisor</strong> from the sidebar and
              describe what you sell and who your ideal customer is. The AI
              uses this to score leads, draft outreach, and find new prospects
              that match your ICP.
            </Text>
          </Section>
          ...
          <Section style={stepBox}>
            ...
            <Text style={stepBody}>
              Go to <strong>Leads</strong> and either add them manually, import
              a CSV, or click <strong>Auto-find leads</strong> to let the AI
              source new prospects for you. Every lead gets an automatic fit
              score so you know who to chase first.
            </Text>
          </Section>
          ...
          <Section style={stepBox}>
            ...
            <Text style={stepBody}>
              The <strong>Pipeline</strong> view shows every lead by stage.
              Drag cards between columns as deals progress, and the activity
              feed keeps a full timeline of calls, emails, and notes for each
              contact.
            </Text>
          </Section>
          ...
          <Section style={stepBox}>
            ...
            <Text style={stepBody}>
              Visit <strong>Workflows</strong> to set up automatic outreach
              sequences — first-touch emails, follow-ups, and reminders trigger
              the moment a lead enters a stage, so nothing slips through the
              cracks.
            </Text>
          </Section>
          ...
          <Text style={featureList}>
            • <strong>Command bar</strong> (press <code style={kbd}>⌘K</code>) — jump anywhere or run an AI action in one keystroke<br />
            • <strong>Campaigns</strong> — launch multi-step outbound sequences with AI-personalised copy<br />
            • <strong>Calendar &amp; Tasks</strong> — never miss a follow-up<br />
            • <strong>Analytics</strong> — see what's converting and where deals are stalling
          </Text>
          ...
          <Text style={footer}>
            Reply to this email any time if you have questions — we're here to
            help.
