 ...
 */
const ContactAcknowledgmentEmail = ({
  name,
  message,
  pricingUrl,
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>Thanks for reaching out to {SITE_NAME} — we'll be in touch {REPLY_WINDOW}.</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            ...
            <strong>{REPLY_WINDOW}</strong> with next steps and a link to book a quick discovery call.
          </Text>
          ...
          <Text style={listItem}>2. You get a reply with a Calendly link to book a 20-minute call.</Text>
          <Text style={listItem}>3. After the call we send a Statement of Work and a Stripe invoice.</Text>
