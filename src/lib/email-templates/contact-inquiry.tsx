...
const ContactInquiryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>New inquiry from {name || 'a visitor'} via the {SITE_NAME} contact form</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={messageBlock}>
          {(message || '(no message provided)').slice(0, 4000)}
        </Text>

        <Hr style={hr} />
        <Text style={footer}>
          Reply directly to this email to respond — the visitor's address is
          set as the Reply-To.
        </Text>
      </Container>
    </Body>
