    ...
    <Html lang="en" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Heads up — the credit balance{orgLine} just dropped below your alert threshold.
          </Text>
          ...
          {autoRechargeEnabled ? (
            <Text style={text}>
              Auto-recharge is <strong>on</strong>, so a top-up pack will be charged to your saved
              card automatically. You can review or change this anytime from your billing page.
            </Text>
          ) : (
            <Text style={text}>
              Auto-recharge is currently <strong>off</strong>. To avoid any interruption, top up
              manually or enable auto-recharge from your billing page.
            </Text>
          )}
          ...
          <Text style={footer}>
            You're receiving this because low-balance alerts are enabled for your {SITE_NAME}{" "}
            workspace. You can change the threshold or turn alerts off from the billing page.
          </Text>
        </Container>
      </Body>
    </Html>
