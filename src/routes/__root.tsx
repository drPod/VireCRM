...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Genesis — Autonomous AI CRM that closes leads for you" },
      { name: "description", content: "Genesis is the AI-powered CRM that follows up, nurtures, and closes your leads automatically — so your business sells 24/7." },
      { name: "theme-color", content: "#9333EA" },
      { property: "og:site_name", content: "Genesis" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Genesis — Autonomous AI CRM that closes leads for you" },
