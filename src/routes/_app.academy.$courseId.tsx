          ...
          {lessons.length === 0 ? (
            ...
            lessons.map((l, i) => {
              ...
              return (
                ...
                >
                  <span
                    className={`mt-0.5 flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold ${done ? "bg-success text-success-foreground" : "bg-muted text-muted-foreground"}`}
                  >
        ...
        <Card className="p-5 space-y-4">
          {active ? (
            <>
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <div>
                  ...
                  {active.duration_minutes && (
                    <p className="text-xs text-muted-foreground">{active.duration_minutes} min</p>
                  )}
                </div>
              ...
              {active.body && (
                <div className="text-sm text-foreground/90 whitespace-pre-wrap">{active.body}</div>
              )}
            </>
          ) : (
