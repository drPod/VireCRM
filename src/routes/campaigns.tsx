...
const mockCampaigns: Campaign[] = [
  ...
  { id: "3", name: "Conference Attendees", objective: "Post-event outreach to booth visitors", status: "completed", leads: 200, sent: 200, replies: 48, conversionRate: 24.0 },
  { id: "4", name: "Product Launch", objective: "Announce new features to warm leads", status: "draft", leads: 1200, sent: 0, replies: 0, conversionRate: 0 },
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        {mockCampaigns.map((campaign) => (
          <div key={campaign.id} className="rounded-xl border border-border bg-card p-5 transition-colors hover:border-primary/30">
            ...
            <div className="mt-4 grid grid-cols-4 gap-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground">{campaign.leads}</p>
