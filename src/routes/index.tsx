...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Majix — Never Let a Lead Go Cold Again" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Majix — Never Let a Lead Go Cold Again" },
      {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background">
        ...
        <p className="mt-4 text-sm font-medium text-muted-foreground">Loading Majix…</p>
      </div>
    );
  }
