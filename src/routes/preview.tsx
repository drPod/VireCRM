...
// ─────────────────────────────────────────────────────────────────────────────
// Per-view "what's simulated / what's disabled" banner
// ─────────────────────────────────────────────────────────────────────────────
...
const VIEW_BANNER_COPY: Record<string, ViewBannerCopy> = {
  ...
  leads: {
    simulated: "Lead list and statuses are demo records.",
...
function PreviewViewBanner({ viewId, label }: { viewId: string; label: string }) {
