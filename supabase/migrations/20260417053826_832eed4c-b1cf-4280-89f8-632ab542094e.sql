-- Extend get_reseller_clients to include assigned reseller plan name and monthly markup.
-- The markup is derived from the client's most recent subscription's reseller_plan.
